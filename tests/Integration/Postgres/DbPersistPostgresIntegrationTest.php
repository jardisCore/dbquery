...
/**
 * PostgreSQL Integration Tests for DbPersist
 *
 * Tests actual INSERT/UPDATE/DELETE query execution against PostgreSQL database
 */
class DbPersistPostgresIntegrationTest extends TestCase
{
    ...
    public function testDeleteByPrimaryKey(): void
    {
        ...
        // Delete first user
        $prepared = $this->persist->delete('users', 'id', $userIdToDelete, 'postgres');
    ...
    {
        $prepared = $this->persist->delete('users', 'id', 99999, 'postgres');
    ...
    public function testCompleteCrudCycle(): void
    {
        ...
        // 3. DELETE
        $deletePrepared = $this->persist->delete('users', 'id', $userId, 'postgres');
